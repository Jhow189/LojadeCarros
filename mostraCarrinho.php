<div class="container-fluid">
    ...
    $carro = $exibe['nm_carro'];  // variável que recebe o carro
	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-sm-1 col-sm-offset-1">
			<img src="imagens/<?php echo $exibe['camin_img']; ?>" class="img-responsive">
		</div>
		
		
		<div class="col-sm-4">
			<h4 style="padding-top:20px"><?php echo $carro; ?></h4>
		</div>	
