...
<head>
<meta charset="utf-8">
<title>Ruryon - Cadastrando um novo produto</title>
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="insprod.php" name="incluiProd" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<label for="txtCarro">Nome do carro</label>
						<input name="txtCarro" type="text" class="form-control" required id="txtCarro">
					</div>
					...
					<label for="txtresumo">Resumo do carro</label>
